...
cadena = input("Ingrese un texto elección: ").lower()
letras = []
...
print("\n")
print("Cantidad de letras encontradas: ")
cantidad_letras1 = cadena.count(letras[0]) #cuenta la cantidad de veces que se repite la letra elegida
cantidad_letras2 = cadena.count(letras[1]) #cuenta la cantidad de veces que se repite la letra elegida
cantidad_letras3 = cadena.count(letras[2]) #cuenta la cantidad de veces que se repite la letra elegida

print(f"Hemoz encontrado la letra '{letras[0]}' repetida {cantidad_letras1} veces")
print(f"Hemoz encontrado la letra '{letras[1]}' repetida {cantidad_letras2} veces")
print(f"Hemoz encontrado la letra '{letras[2]}' repetida {cantidad_letras3} veces")

print("\n")
print("Cantidad de Palabras: ")
palabras = cadena.split() #separa las palabras por espacio vacio
...
primera_letra = cadena[0] #almacena la primera letra
ultima_letra = cadena[-1] #almacena la ultima letra
...
busca_python = "python" in cadena #verifica si python esta en el texto
